...
public class PetClinicRestControllerTest {
    ...
    public void testDeleteOwner() {
        ...
        try {
            ...
            Assert.fail("should have not returned an owner");
        }
    ...
    public void testGetOwnersByLastName(){
        ResponseEntity<List> response = restTemplate.getForEntity("http://localhost:8080/rest/owner?ln=Ferit", List.class);
        ...
        MatcherAssert.assertThat(firstNames, Matchers.containsInAnyOrder("Ziya"));
    }
    ...
    public void testGetOwners(){
        ...
        MatcherAssert.assertThat(firstNames, Matchers.containsInAnyOrder("Ziya", "Beşir", "Eda"));
